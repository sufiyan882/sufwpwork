<?php 
	...
	*/		
	...
	if( is_admin() ){ add_action('after_setup_theme', 'kleanity_change_tgmpa_location', 20); }
	if( !function_exists('kleanity_change_tgmpa_location') ){
		function kleanity_change_tgmpa_location(){
			...
			if( class_exists('gdlr_core_admin_menu') ){
				gdlr_core_admin_menu::register_menu(array(
					...
					'menu-title' => esc_html__( 'Install Plugins', 'kleanity' ),
					'page-title' => esc_html__( 'Install Required Plugins', 'kleanity' ),
	...
	if( !function_exists('kleanity_tgmpa_complete') ){
		function kleanity_tgmpa_complete(){
	...
	// auto install and redirect to plugin page
	if( !function_exists('kleanity_tgmpa_is_plugin_active') ){
		function kleanity_tgmpa_is_plugin_active($slug, $redirect_url){
	...
	if( !function_exists('kleanity_tgmpa_auto_install_url') ){
		function kleanity_tgmpa_auto_install_url($slug, $redirect_url){
	...
	add_action('tgmpa_register', 'kleanity_register_required_plugins');
	if( !function_exists('kleanity_register_required_plugins') ){
		function kleanity_register_required_plugins(){
			
			$plugins = array(
				array(
					'name'               => esc_html__('Goodlayers Core', 'kleanity'),
				...
				array(
					'name'               => esc_html__('Goodlayers Core Portfolio', 'kleanity'),
				...
				array(
					'name'               => esc_html__('Goodlayers Core Personnel', 'kleanity'),
				...
				array(
					'name'               => esc_html__('Goodlayers Core Twitter', 'kleanity'),
				...
				array(
					'name'               => esc_html__('Envato Market', 'kleanity'),
					'slug'               => 'envato-market', 
				...
				array(
					'name'               => esc_html__('Revolution Slider', 'kleanity'),
					'slug'               => 'revslider', 
				...
				array(
					'name'      => esc_html__('Contact Form 7', 'kleanity'),
					'slug'      => 'contact-form-7',
					'required'  => false,
				),
				array(
					'name'      => esc_html__('WP Google Map Plugin', 'kleanity'),
					'slug'      => 'wp-google-map-plugin',
					'required'  => false,
				),
				array(
					'name'      => esc_html__('Snazzy Maps', 'kleanity'),
					'slug'      => 'snazzy-maps',
					'required'  => false,
				),
			);
			...
			$config = array(
				'id'           => 'kleanity',                 // Unique ID for hashing notices for multiple instances of TGMPA.
		...
		} // kleanity_register_required_plugins
	} // function_exists