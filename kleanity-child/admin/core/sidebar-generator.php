		...
		class gdlr_core_sidebar_generator{
			...
			function __construct( $sidebar_args = array() ){
				...
				$this->footer_widgets = array(
					array( 'name'=>esc_html__('Footer 1', 'kleanity'), 'id'=>'footer-1', 'description'=>esc_html__('Footer Column 1', 'kleanity') ), 
					array( 'name'=>esc_html__('Footer 2', 'kleanity'), 'id'=>'footer-2', 'description'=>esc_html__('Footer Column 2', 'kleanity') ), 
					array( 'name'=>esc_html__('Footer 3', 'kleanity'), 'id'=>'footer-3', 'description'=>esc_html__('Footer Column 3', 'kleanity') ), 
					array( 'name'=>esc_html__('Footer 4', 'kleanity'), 'id'=>'footer-4', 'description'=>esc_html__('Footer Column 4', 'kleanity') )
				);
			...
			function register_sidebar_widget(){
				...
				$sidebar_args['name'] = __('Preset', 'kleanity');
				$sidebar_args['id'] = 'gdlr-core-sidebar-preset';
				$sidebar_args['description'] = esc_html__('Another Custom widget area', 'kleanity');
				...
				foreach ( $this->sidebars as $sidebar ){
					...
					$sidebar_args['description'] = esc_html__('Custom widget area', 'kleanity');
